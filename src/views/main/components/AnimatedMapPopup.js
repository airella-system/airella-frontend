...
class AnimatedMapPopup extends Component {
  constructor(props) {
    ...
    this.emojis = {
      ...
      0: {
        ...
        topleft: {
          transform: `translate(-23%, ${
            8 + this.vars.verticalEmojiShift
          }%) scale(0.3)`,
        ...
        bottom: {
          transform: `translate(0, ${
            50 + this.vars.verticalEmojiShift
          }%) scale(0.7)`,
      ...
      1: {
        ...
        topleft: {
          transform: `translate(-23%, ${
            0 + this.vars.verticalEmojiShift
          }%) scale(0.23)`,
        ...
        bottom: {
          transform: `translate(0, ${
            58 + this.vars.verticalEmojiShift
          }%) scale(0.7)`,
      ...
      2: {
        ...
        bottom: {
          transform: `translate(0, ${
            62 + this.vars.verticalEmojiShift
          }%) scale(0.65)`,
      ...
      4: {
        ...
        bottom: {
          transform: `translate(0, ${
            48 + this.vars.verticalEmojiShift
          }%) scale(0.5)`,
  ...
  totalCount = () =>
    Object.keys(this.vars.sensorValues).length +
    Object.keys(this.vars.additionalValues).length +
    this.vars.count;
          ...
          <div className={styles.animatedPopupPoint} ref="point">
            <div ref="morphbutton" className={styles.morphEmoji}>
              <div
                ref="left"
                style={{
                  clipPath: this.emojis.default.topleft.polygon,
                  transform: this.emojis.default.topleft.transform,
              ...
              <div
                ref="right"
                style={{
                  clipPath: this.emojis.default.topright.polygon,
                  transform: this.emojis.default.topright.transform,
                  background: this.props.color,
                }}
              ></div>
              <div
                ref="bottom"
                style={{
                  clipPath: this.emojis.default.bottom.polygon,
                  transform: this.emojis.default.bottom.transform,
                  background: this.props.color,
                }}
              ></div>
            </div>
