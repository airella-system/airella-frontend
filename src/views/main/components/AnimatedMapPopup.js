...
class AnimatedMapPopup extends Component {
    ...
    this.paths = {
      ...
      happyOpenMouth: "polygon(0.194% 10.428%, -0.015% 6.931%, 0.965% 3.565%, 3.378% 1.222%, 6.465% 0.151%, 13.176% 0.469%, 29.680% 3.240%, 46.378% 4.410%, 63.107% 3.952%, 79.709% 1.841%, 87.465% 0.331%, 91.369% 0.000%, 95.248% 0.556%, 97.890% 2.181%, 99.454% 4.722%, 100.001% 7.743%, 99.593% 10.806%, 96.273% 19.802%, 90.724% 27.595%, 83.582% 34.099%, 75.482% 39.230%, 69.186% 42.041%, 62.570% 43.903%, 55.756% 44.874%, 48.864% 45.013%, 37.618% 44.047%, 37.618% 44.047%, 37.618% 44.047%, 26.817% 40.377%, 16.958% 34.540%, 8.625% 26.741%, 2.400% 17.181%)",
      ...
      straightMouth: "polygon(0.268% 6.894%, 0.001% 5.405%, 0.127% 3.904%, 0.657% 2.515%, 1.602% 1.362%, 2.972% 0.570%, 4.311% 0.087%, 5.743% 0.001%, 7.935% 0.055%, 95.865% 0.043%, 97.766% 1.078%, 98.570% 1.805%, 99.230% 2.646%, 99.712% 3.582%, 99.980% 4.592%, 100.000% 5.658%, 99.738% 6.759%, 99.175% 8.103%, 98.335% 9.058%, 97.275% 9.691%, 96.055% 10.069%, 93.359% 10.328%, 90.711% 10.369%, 50.891% 10.480%, 11.071% 10.392%, 7.184% 10.354%, 5.244% 10.280%, 3.323% 10.049%, 3.323% 10.049%, 3.323% 10.049%, 1.940% 9.341%, 0.918% 8.248%)",
    ...
    this.emojis = {
      ...
      verybad: {
		...
		this.state = {
      defaultEmoji: this.emojis.default,
    };
  }
      ...
      <div className="animated-popup-content">
        ...
        {pm1Data && this.makeContentContainer(i++, (
          <div className="sensor-info">
            ...
            <div className="value"> {Math.round(pm1Data.value / 45 * 100)} <span>%</span> </div>
          </div>
        ))}
